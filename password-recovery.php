...
if (isset($_POST['change'])) {
    ...
    $con = "UPDATE employees set UserPassword=:newpassword where id=:empid";
                        ...
                        <div class="login-form-body">
                            <form method="POST" name="updatepwd">
                                <div class="form-gp">
                                    ...
                                    <input type="text" name="empid" value="<?php echo isset($empid) ? $empid : ''; ?>" <?php echo isset($readonly) ? $readonly : ''; ?>>
                                    <i class="ti-key"></i>
                                    <div class="text-danger"></div>
                                </div>
                                <div class="form-gp">
                                    <label for="exampleInputPassword1">Confirm Password</label>
                                    <input type="text" name="emailid" value="<?php echo isset($email) ? $email : ''; ?>" <?php echo isset($readonly) ? $readonly : ''; ?>>
                                    <i class="ti-key"></i>
                                    <div class="text-danger"></div>
                                </div>
